...
const ContextApi = () => {
    return (
        <div className='w-[90%] md:w-[80%] mx-auto shadow-lg bg-slate-100 py-10 px-16 mb-20 rounded'>
            <h1 className='text-3xl text-center font-semibold mb-10'>Context Api: How it works?</h1>
            <p className='text-lg'>
